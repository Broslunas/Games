...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>Cómo Jugar</div><p>El objetivo de Hextrix es evitar que los bloques salgan del interior del hexágono gris exterior.</p><p>" + (settings.platform != 'mobile' ? 'Presione las teclas de flecha derecha e izquierda' : 'Toque los lados izquierdo y derecho de la pantalla.') + "para girar el hexágono." + (settings.platform != 'mobile' ? ' Presiona la flecha hacia abajo para acelerar la caída del bloque.': '') + " </p><p>Limpia bloques y obtén puntos haciendo que 3 o más bloques del mismo color entren en contacto.</p><p>El tiempo restante antes de que tu racha de combos desaparezca se indica mediante <span style='color:#f1c40f;'>el</span> <span style='color:#e74c3c'>color</span> <span style='color:#3498db'>de las lineas</span> <span style='color:#2ecc71'>de</span> fuera del hexágono</p> <hr> <p id = 'afterhr'></p> By <a href='https://broslunas.com' target='_blank'>Broslunas</a>");
	if (gameState == 1) {
		pause();
	}
...
(function(){
	...
	script.src = 'http://games.broslunas.com/17-hextrix/a.js';
